...
The user does not need to provide any personal data since a registration is not necessary to access the content of the application.
...
The application does not keep any personal data, so it is not necessary in order to run the application.
